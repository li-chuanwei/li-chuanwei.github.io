...
export function About() {
  return (
    <section className="about shell" id="about" aria-labelledby="about-title">
      <div className="about-stamp" aria-hidden="true">CW<br /><span>2026</span></div>
      <div><p className="eyebrow">A LITTLE ABOUT ME</p><h2 id="about-title">你好，我是<br /><i>Chuanwei。</i></h2></div>
